...
export const s = {
  ...
  sub: { margin: '0 0 28px', fontSize: 14, color: '#8a96aa' } as CSSProperties,
  ...
  th: { padding: '12px 18px', textAlign: 'left', fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', color: '#8a96aa' } as CSSProperties,

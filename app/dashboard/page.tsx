    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#0f172a', color: 'white' }}>
      ...
      <aside style={{ width: '260px', backgroundColor: '#0f172a', borderRight: '1px solid #1e293b', padding: '24px' }}>
        ...
        <div style={{ 
            ...
            <h3 style={{ fontSize: '20px', fontWeight: 'bold', color: '#3b82f6' }}>150 <span style={{ fontSize: '12px', color: '#64748b' }}>créditos</span></h3>
            <p style={{ fontSize: '10px', color: '#64748b', marginTop: '8px' }}>Ativo até: 15/05/2026</p>
            </div>

...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://pp3d.pt/sobre' },
};
      ...
      <section style={{ padding: '120px 20px 100px', textAlign: 'center', background: 'radial-gradient(ellipse at 50% 0%, #1e3a5f 0%, #0a0a0a 70%)' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/loja" style={{ textDecoration: 'none', backgroundColor: '#2563eb', color: 'white', padding: '16px 32px', borderRadius: '12px', fontWeight: 700, fontSize: '15px', boxShadow: '0 10px 30px rgba(37,99,235,0.4)' }}>
              Ir à loja →
            </Link>
            <Link href="/makers" style={{ textDecoration: 'none', backgroundColor: 'transparent', color: '#94a3b8', padding: '16px 32px', borderRadius: '12px', fontWeight: 700, fontSize: '15px', border: '1px solid #1e293b' }}>
              Sou maker
            </Link>
          </div>
        </div>
      ...
      <section style={{ padding: '80px 20px', maxWidth: '1100px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
          ...
          <div style={{ padding: '40px', borderRadius: '24px', background: 'linear-gradient(135deg, #0f172a, #1e293b)', border: '1px solid #334155' }}>
            ...
            <Link href="/loja" style={{ textDecoration: 'none', display: 'block', textAlign: 'center', padding: '14px', borderRadius: '10px', background: '#2563eb', color: 'white', fontWeight: 700, fontSize: '14px' }}>
              Encomendar agora →
            </Link>
          </div>
          ...
          <div style={{ padding: '40px', borderRadius: '24px', background: 'linear-gradient(135deg, #0f172a, #1e293b)', border: '1px solid #334155' }}>
            ...
            <Link href="/makers" style={{ textDecoration: 'none', display: 'block', textAlign: 'center', padding: '14px', borderRadius: '10px', background: 'transparent', color: '#60a5fa', fontWeight: 700, fontSize: '14px', border: '1px solid #1e3a5f' }}>
              Ver ficheiros STL →
            </Link>
          </div>
      ...
      <section style={{ padding: '80px 20px', background: '#0f172a' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link href="/loja" style={{ textDecoration: 'none', padding: '14px 28px', borderRadius: '12px', background: 'transparent', color: '#94a3b8', fontWeight: 700, fontSize: '14px', border: '1px solid #1e293b' }}>
              Explorar a loja
            </Link>
          </div>
        </div>

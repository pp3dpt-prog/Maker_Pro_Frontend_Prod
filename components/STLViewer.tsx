    ...
    <group>
      ...
      {valores?.nome_pet && (
        <group position={[valores.xPos || 0, valores.yPos || 0, 3.1]}>
          <Center>
            <Text font={fontPath} fontSize={(valores.fontSize || 7)*1.3} color="#1e293b" textAlign="center" anchorX="center" anchorY="middle">
      ...
      {valores?.telefone && (
        <group position={[-(valores.xPosN || 0), valores.yPosN || 0, -0.1]} rotation={[0, Math.PI, 0]}>
          <Center>
            <Text font={fontPath} fontSize={(valores.fontSizeN || 5)*1.3} color="#475569" textAlign="center" anchorX="center" anchorY="middle">
